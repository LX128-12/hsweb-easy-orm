...
public class KingbaseMssqlTableMetadataParser extends RDBTableMetadataParser {
    ...
    public KingbaseMssqlTableMetadataParser(RDBSchemaMetadata schema) {
        super(schema);
    }
    ...
    protected void applyColumnInfo(RDBColumnMetadata column, Record record) {
        ...
        if (column.getLength() <= 0
            && column.getType() != null
            && column.getType().isLengthSupport()) {
