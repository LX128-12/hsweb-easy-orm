...
public class KingbaseMssqlCreateIndexSqlBuilder implements CreateIndexSqlBuilder {

    public static final KingbaseMssqlCreateIndexSqlBuilder INSTANCE = new KingbaseMssqlCreateIndexSqlBuilder();
