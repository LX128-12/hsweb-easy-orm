...
public class KingbaseOracleCreateIndexSqlBuilder implements CreateIndexSqlBuilder {

    public static final KingbaseOracleCreateIndexSqlBuilder INSTANCE = new KingbaseOracleCreateIndexSqlBuilder();
