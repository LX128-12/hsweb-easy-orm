...
public class KingbaseMssqlEnumAndUpsertTest extends AbstractKingbaseMssqlJdbcTestSupport {
    ...
    public void testEnumLikeQuery() {
        ...
        try {
            ...
            List<Map<String, Object>> activeRows = operator.dml()
                ...
                .fetch(mapList())
                .sync();
            Assert.assertEquals(2, activeRows.size());
        } finally {
            dropTableQuietly(qualified);
        }
    }
