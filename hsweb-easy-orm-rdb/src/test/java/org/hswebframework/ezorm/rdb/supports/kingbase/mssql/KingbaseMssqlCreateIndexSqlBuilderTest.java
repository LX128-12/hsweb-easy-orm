...
public class KingbaseMssqlCreateIndexSqlBuilderTest {
    ...
    public void testBuildPlainIndex() {
        ...
        SqlRequest result = KingbaseMssqlCreateIndexSqlBuilder.INSTANCE.build(
    ...
    public void testBuildUniqueIndex() {
        ...
        RDBIndexMetadata index = new RDBIndexMetadata();
        index.setName("idx_test_code_unique");
    ...
    public void testBuildIndexWithNonExistentColumnThrows() {
        ...
        KingbaseMssqlCreateIndexSqlBuilder.INSTANCE.build(
            CreateIndexParameter.of(table, index));
    }
}
