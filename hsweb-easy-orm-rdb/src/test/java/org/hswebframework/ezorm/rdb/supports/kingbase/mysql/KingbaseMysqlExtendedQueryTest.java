...
public class KingbaseMysqlExtendedQueryTest extends AbstractKingbaseMysqlJdbcTestSupport {
    ...
    public void testLikeQuery() {
        ...
        try {
            ...
            // contains match: name like '%hello%'
