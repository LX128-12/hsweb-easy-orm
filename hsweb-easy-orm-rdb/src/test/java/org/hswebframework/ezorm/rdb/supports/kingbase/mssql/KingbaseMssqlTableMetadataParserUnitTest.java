...
public class KingbaseMssqlTableMetadataParserUnitTest {
    ...
    public void testShouldApplyLengthPrecisionAndScaleFromLengthSupportWhenMissing() {
        ...
        Record record = Record.newRecord()
                              .putValue("name", "title")
                              .putValue("data_type", "character varying")
    ...
    private static class TestParser extends KingbaseMssqlTableMetadataParser {

        private TestParser() {
            super(new KingbaseMssqlSchemaMetadata("public"));
        }
